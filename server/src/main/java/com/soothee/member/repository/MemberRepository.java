...
public interface MemberRepository extends JpaRepository<Member, Long> {
     ...
     * @return 조회한 회원(Null 가능)
     */
    Optional<Member> findByEmailAndIsDelete(String email, String isDelete);
     ...
     * @return 조회한 회원(Null 가능)
     */
    Optional<Member> findByMemberIdAndIsDelete(Long memberId, String isDelete);
}
