...
public enum MyErrorMsg {
    ...
    INCORRECT_VALUE("값의 형식이 잘못되었습니다."),
    ...
    public String makeValue(String msg) {
        if (!Objects.equals(this, NULL_VALUE)) {
            throw new MissMethodMatchForErrorMsg("MyErrorMsg.NULL_VALUE만 사용 가능합니다.");
        }
        return msg + NULL_VALUE.msg;
    }
    public String makeIncorrect(String msg) {
        if (!Objects.equals(this, INCORRECT_VALUE)) {
            throw new MissMethodMatchForErrorMsg("MyErrorMsg.INCORRECT_VALUE만 사용 가능합니다.");
        }
        return msg + INCORRECT_VALUE.msg;
    }
}
